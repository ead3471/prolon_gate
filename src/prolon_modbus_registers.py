...
class ModbusRequest:
    ...
    @classmethod
    def create_read_hold_regs_req(cls, start, stop, uid):
        return ModbusRequest(3, start, stop, uid)

    @classmethod
    def create_read_input_regs_req(cls, start, stop, uid):
        return ModbusRequest(4, start, stop, uid)
